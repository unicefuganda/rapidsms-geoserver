...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PollData.total_yes'
        db.add_column('geoserver_polldata', 'total_yes',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PollData.total_no'
        db.add_column('geoserver_polldata', 'total_no',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PollData.total_uncategorized'
        db.add_column('geoserver_polldata', 'total_uncategorized',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PollData.total_unknown'
        db.add_column('geoserver_polldata', 'total_unknown',
                      self.gf('django.db.models.fields.FloatField')(default=0, max_length=5, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PollData.total_yes'
        db.delete_column('geoserver_polldata', 'total_yes')

        # Deleting field 'PollData.total_no'
        db.delete_column('geoserver_polldata', 'total_no')

        # Deleting field 'PollData.total_uncategorized'
        db.delete_column('geoserver_polldata', 'total_uncategorized')

        # Deleting field 'PollData.total_unknown'
        db.delete_column('geoserver_polldata', 'total_unknown')
